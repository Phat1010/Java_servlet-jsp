...
/**
 * Servlet implementation class pracctice_Exam_Read
 */
@WebServlet("/pracctice_Exam_Read")
public class pracctice_Exam_Read extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public pracctice_Exam_Read() {
        super();
