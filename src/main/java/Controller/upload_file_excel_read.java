...
/**
 * Servlet implementation class upload_file_excel_read
 */
@WebServlet("/upload_file_excel_read")
@MultipartConfig(fileSizeThreshold = 1024 * 1024 * 2, // 2MB
maxFileSize = 1024 * 1024 * 50, // 50MB
maxRequestSize = 1024 * 1024 * 50) // 50MB

public class upload_file_excel_read extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public upload_file_excel_read() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/View/Admin/addRead_excel.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Part part : request.getParts()) {
		    ...
		    getServletContext().getRequestDispatcher("/WEB-INF/View/Admin/addRead_excel.jsp").forward(request, response);
		  }
		  /**
