...
/**
 * Servlet implementation class Delete_Table_Exam
 */
@WebServlet("/Delete_Table_Exam")
public class Delete_Table_Exam extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Delete_Table_Exam() {
        super();
	...
	int id= Integer.parseInt(request.getParameter("delete1"));
		...
		boolean test = ManageExamDAO.deleteExam(request, conn, id, "examination");
		if(test)
		{
