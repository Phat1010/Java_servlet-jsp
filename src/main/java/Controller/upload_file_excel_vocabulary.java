...
/**
 * Servlet implementation class upload_file_excel_vocabulary
 */
@WebServlet("/upload_file_excel_vocabulary")
...
public class upload_file_excel_vocabulary extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public upload_file_excel_vocabulary() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/View/Admin/addVocabulary_details.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (Part part : request.getParts()) {
		    ...
		    getServletContext().getRequestDispatcher("/WEB-INF/View/Admin/addVocabulary_details.jsp").forward(request, response);
		  }
		  /**
