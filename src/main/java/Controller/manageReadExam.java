...
/**
 * Servlet implementation class manageReadExam
 */
@WebServlet("/manageReadExam")
public class manageReadExam extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public manageReadExam() {
        super();
...
RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/View/Admin/manageExamRead.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		read read= new read();
		read.setReadname(title);
		
	
		boolean test= manageReadExamDAO.InsertRead(request, conn, read);
		
		
		if (test) {
			
			
			RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/View/Admin/addimageRead.jsp");
			rd.forward(request, response);
