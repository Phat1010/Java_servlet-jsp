...
public class ExaminationDAO {
	...
	public static List<examination> listExamfind (HttpServletRequest request ,Connection conn, String search){
		...
		try {
			...
			PreparedStatement ptmt = null;
			String sql = "select * from toeic.examination  where examinationname like '%"+search+"%'";
			ptmt = conn.prepareStatement(sql);
			...
			if(rs.isBeforeFirst()) {//have data
				...
				request.setAttribute("msglistexam", "No Documents");
			}
