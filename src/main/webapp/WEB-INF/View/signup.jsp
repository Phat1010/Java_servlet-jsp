...
<head>
  	...
  	function Validate()
	{
		...
		if (password == "")
		{
			document.getElementById("errorpass").innerHTML = "not to blank email";
		}
		else 
		{
			...
			{
				document.getElementById("errorpass").innerHTML = "Large length over 6";
			}
			else 
			{
				document.getElementById("errorpass").innerHTML = "";
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form name="myform" method="POST" class="register-form" id="register-form" action="SignUpController" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="pass" id="pass" placeholder="Password" onkeyup="Validate()"/>
                            </div>
                            <div class="form-group">
