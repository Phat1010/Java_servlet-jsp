...
<body>
       ...
       <jsp:include page="barmenu.jsp"></jsp:include>
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h1 class="page-title">ADD IMAGE Read </h1>
                    </div>
          ...
          <!-- image -->
             ...
             <form method="post" action="upload_file_image_read" enctype="multipart/form-data">
    ...
    <input type="submit" value="Upload" />
        ...
        <!-- end image -->  
          ...
          <form action="add_image_read" method="post">
          	<input type="text" value="${requestScope.message2}" name="imageread" hidden="false">
