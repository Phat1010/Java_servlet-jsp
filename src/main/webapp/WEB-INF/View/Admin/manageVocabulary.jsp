...
<div class="container">
  ...
  <c:forEach items="${listvocalbulary}" var="listvocalbulary">
    <tr>
    <td><input type="checkbox" class="checkthis" /></td>
<td>${listvocalbulary.idvocabulary}</td>
      <td>${listvocalbulary.vocabularyname}</td> 
      
    
           <td>${listvocalbulary.vocabularyimage}</td>
              


    <td><p data-placement="top" data-toggle="tooltip" title="Edit"><a href="upload_file_excel_vocabulary?id=${listvocalbulary.idvocabulary}"> <button  class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" value="${listvocalbulary.idvocabulary}"  name="edit1"><span class="glyphicon glyphicon-pencil"></span></button></a></p></td>
    <td><p data-placement="top" data-toggle="tooltip" title="Delete"><a href="Delete_Table_Vocabulary?delete1=${listvocalbulary.idvocabulary}"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete"  value="${listvocalbulary.idvocabulary}"  name="delete1"><span class="glyphicon glyphicon-trash"></span></button></a></p></td>
    	
    	<c:if test="${listvocalbulary.checktable==1}">
    	<td><p data-placement="top" data-toggle="tooltip" title="Checked data"><a><!--  --><span class="far fa-check-circle"></span></a></p></td>
    	
    	</c:if>
    	
    	   	
    	<c:if test="${listvocalbulary.checktable==0}">
...
<ul class="pagination pull-right">
  ...
  <c:if test="${currentpage==1}">
   ...
   <!--  <li ><a class="page-link" href="pagination?pageid=1">1</a></li>
    ...
    <li class="page-item"><a class="page-link" href="manage_Vocabulary?pageid=${currentpage-1}">Previous</a></li>
   <!--  <li ><a class="page-link" href="pagination?pageid=1">1</a></li>
    <li ><a class="page-link" href="pagination?pageid=2">2</a></li>
    <li ><a class="page-link" href="pagination?pageid=3">3</a></li> -->
    <li class="page-item"><a class="page-link" href="manage_Vocabulary?pageid=${currentpage+1}">Next</a></li>
